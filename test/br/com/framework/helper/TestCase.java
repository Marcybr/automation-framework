...
public class TestCase extends PageFactory {
	...
	public void saveScreenshot(WebElement element, Boolean crop, Boolean highlight, WebDriver driver) throws IOException {
		...
		outputfileName.append("./prints/");
		outputfileName.append(Constants.XpathProperties.UNDERLINE);
		...
		outputfileName.append(Constants.XpathProperties.PONTO);
		outputfileName.append(Constants.XpathProperties.PNG);
		...
		ImageIO.write(imagem, Constants.XpathProperties.PNG, outputfile);
